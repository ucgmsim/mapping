...
BASINS = {
    ...
    "Nelson_Polygon_WGS84.txt": ("Nelson", 10),
    "NewCanterburyBasinBoundary_WGS84_1m.txt": ("New Canterbury", 11),
    "NorthCanterbury_Polygon_WGS84.txt": ("North Canterbury", 12),
    "SpringsJ_basin_outline_v1_WGS84.txt": ("Springs Junction", 13),
    "WaikatoHaurakiBasinEdge_WGS84.txt": ("Waikato Hauraki", 14),
    "WakatipuBasinOutlineWGS84.txt": ("Wakatipu", 15),
    "WanakaOutlineWGS84.txt": ("Wanaka", 16),
    "Wellington_Polygon_Wainuiomata_WGS84.txt": ("Wellington", 17),
    "alexandra_outline.txt": ("Alexandra", 18),
    "bal_outline_WGS84.txt": ("Balclutha", 19),
    "dun_outline_WGS84.txt": ("Dunedin", 20),
    "hakataramea_outline_WGS84.txt": ("Hakataramea", 21),
    "mos_outline_WGS84.txt": ("Mosgiel", 22),
    "ranfurly_outline.txt": ("Ranfurly", 23),
    "waitaki_outline_WGS84.txt": ("Waitaki", 24),
}
